...
?>
  ...
  <div id="page" class="mast">
    ...
    <div class="wrap-columns clearfix">
      ...
      <?php print render($page['peripheral1']); ?>
      ...
      <div class="content-column">
        <div role="main" class="main">
          ...
          <?php if ($title): ?><h1 class="title page-title block"><?php print $title; ?></h1><?php endif; ?>
          ...
          <?php if ($feed_icons): ?><div class="block wrap-feed-icons"><?php print $feed_icons; ?></div><?php endif; ?>
        </div> <!-- end .main -->
      </div> <!-- end .content-column -->
      <?php print render($page['peripheral2']); ?>
    ...
    <?php if (isset($ice_attr_link)): print $ice_attr_link; endif; ?>
